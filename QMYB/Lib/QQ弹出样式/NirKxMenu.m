...
- (UIView *) mkContentView
{
    ...
    for (KxMenuItem *menuItem in _menuItems) {
        ...
        if (menuItem.title.length) {
            ...
            titleLabel.textColor = [UIColor colorWithRed:self.kxMenuViewOptions.textColor.R green:self.kxMenuViewOptions.textColor.G blue:self.kxMenuViewOptions.textColor.B alpha:0.9];
...
+ (UIImage *) gradientLine: (CGSize) size
{
    ...
    const CGFloat R = 0.5f, G = 0.5, B = 0.5; //分隔线的颜色 -- 隐藏属性
